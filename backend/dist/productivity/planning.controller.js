...
const planning_request_dto_1 = require("./dto/planning-request.dto");
let PlanningController = class PlanningController {
    constructor(productivityService) {
        this.productivityService = productivityService;
    }
    getRecommendations(user, dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, planning_request_dto_1.PlanningRequestDto]),
